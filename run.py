...
if __name__ == '__main__':
    ...
    # cross-dataset transfer: train on --data, test on --target_data
    parser.add_argument('--target_data', type=str, default=None,
                        help='target dataset type for cross-dataset transfer test (e.g. ETTh2). If set, the test split uses this dataset while train/val still use --data')
    parser.add_argument('--target_root_path', type=str, default=None,
                        help='root path of the target dataset file (defaults to --root_path)')
    parser.add_argument('--target_data_path', type=str, default=None,
                        help='target dataset file (e.g. ETTh2.csv)')
    parser.add_argument('--target_target', type=str, default=None,
                        help='target feature name for the target dataset (defaults to --target)')
